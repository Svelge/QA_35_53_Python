...
with open("users_1.csv") as file:
    reader = csv.reader(file) # reader в данном случае объект который умеет отдавать одну строчку за другой
    print(type(reader))
...
#dict reader - читает не как список, а как словарь, где заголовок это ключ
...
#dict - берет первую строчку за ключи 
